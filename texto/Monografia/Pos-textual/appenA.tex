...
% \verb|Dockerfile| referente aos dispositivos virtuais Ubuntu (1 à 3):
% \begin{lstlisting}[breaklines=true, basicstyle=\small\ttfamily]
% FROM ubuntu:24.04
...
% \verb|Dockerfile| referente aos dispositivos virtuais Alpine (4 e 5):
% \begin{lstlisting}[breaklines=true, basicstyle=\small\ttfamily]
% FROM alpine:3.21.3

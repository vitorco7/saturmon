...
Como mencionado anteriormente,\todo[inlinewidth=1]{redigir a intro do capitulo para referenciá-la aqui} o sistema operacional a ser utilizado deve ser de código aberto. Diante disso, as seguintes distribuições Linux foram consideradas para o projeto.

...
Nesta seção, examinam-se duas das principais soluções adotadas no ecossistema de código aberto: o subsistema de alertas integrado do Grafana e o Alertmanager do Prometheus.
...
\citep{promalertmanager2025}
\citep{grafanaalerting2025}
}

...
\begin{itemize}
\item \textbf{Espaço livre}: quantidade de espaço livre em disco, em \foreign{bytes}. Quando próximo de 0, pode causar degradação de desempenho, corrupção de dados, congelamentos e \foreign{crashes};

\item \textbf{Espaço utilizado}: quantidade de espaço utilizado, em \foreign{bytes};

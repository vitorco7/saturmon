...
No contexto deste projeto, a natureza das informações coletadas --- predominantemente séries temporais --- exige a avaliação de diferentes abordagens de armazenamento, incluindo bancos de dados relacionais tradicionais e soluções especializadas em dados temporais.

%inserir a tabela comparativa entre os SGBDS


As subseções a seguir apresentam os bancos de dados analisados para o projeto, destacando suas principais características.

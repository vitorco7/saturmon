...
Além da aleatoriedade nas durações, a carga aplicada nos testes também é definida de maneira aleatória. No stress-ng, essa carga corresponde ao número de \foreign{workers}, ou seja, processos ou \foreign{threads} inicializados para executar os testes. Antes de cada execução de bloco, novas cargas são estabelecidas.

Na figura 3.13, os \foreign{scripts} são representados pelo símbolo \includegraphics[height=1em]{Imagens/chap03/input_black.png}.

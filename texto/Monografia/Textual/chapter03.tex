...
\multirow{4}{*}{CPU} & Carga do usuário & usage\_user(\%) & user\_usec \\ \cline{2-4}
                     & Carga do sistema & usage\_system(\%) & system\_usec \\ \cline{2-4}
                     & Aguardo de I/O & usage\_iowait(\%) & --- \\ \cline{2-4}
                     & Tempo ocioso & usage\_idle(\%) & cpu.idle \\ \hline
...
\multirow{7}{*}{Disco} & Espaço livre & free(Bytes)         & ---     \\ \cline{2-4}
                       ...
                       & Bytes lidos & read\_bytes(Bytes)  & rbytes \\ \cline{2-4}
                       & Bytes escritos & write\_bytes(Bytes) & wbytes \\ \cline{2-4}
                       & Utilização I/O & io\_util(\%)     & ---     \\ \hline
\multirow{8}{*}{Rede} & Bytes recebidos & bytes\_recv     & bytes\_recv \\ \cline{2-4}
                      & Bytes enviados & bytes\_sent     & bytes\_sent \\ \cline{2-4}
                      & Pacotes recebidos & packets\_recv   & packets\_recv \\ \cline{2-4}
                      & Pacotes enviados & packets\_sent   & packets\_sent \\ \cline{2-4}
                      & Pacotes descartados (entrada) & drop\_in        & drop\_in          \\ \cline{2-4}
                      & Pacotes descartados (saída) & drop\_out       & drop\_out         \\ \cline{2-4}
                      & Pacotes com erro (entrada) & err\_in         & err\_in         \\ \cline{2-4}
                      & Pacotes com erro (saída) & err\_out        & err\_out        \\ \hline

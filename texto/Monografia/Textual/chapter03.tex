...
\begin{lstlisting}[caption={Leitura de um único arquivo com inputs.exec}, label={lst:trecho1}]
[[inputs.exec]]
...
\begin{lstlisting}[caption={Leitura de diversos arquivos com inputs.cgroups}, label={lst:trecho2}]
[[inputs.cgroup]]
  paths = ["/sys/fs/cgroup/"]
  files = [
    "cpu.idle",

...
%- Falar o que eu fiz com o zabbix: 
% subi os containers
% instalei um agente nao oficial no meu celular
% consegui pingar o meu celular a partir do container do servidor
% consegui vincular o container do agente ao servidor
% acabei nao gostando da interface e navegabilidade
% dificuldade realizar configurações avançadas via interface web
% os arquivos do projeto do Zabbix são muito inchados e extensos, o que dificultou a leitura e compreensão do código
% por ter características monolíticas, o Zabbix estava difícil de compreender e manter.
% É mais custoso computacionalmente (precisa de um banco de dados acoplado como o MySQL ou Postgres)
% unindo a curva de aprendizado do Docker com a do Zabbix, somado aos itens acima, foi custoso, o que me fez trocar pro Prometheus 
}
